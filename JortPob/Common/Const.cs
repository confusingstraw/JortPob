...
namespace JortPob.Common
{
    public static class Const
    {
        ...
        public static readonly int[] DEBUG_EXCLUSIVE_BUILD_BY_BOX = new int[] { -4, 5, 0, 10 }; // also set to null to build entire map. format x1, y1, x2, y2. smaller values first, 1 = 1 cell, use cell coordinates
        ...
        public static bool DEBUG_EXCLUSIVE_INTERIOR_BUILD_NAME(string name)
        {
            ...
            string[] MATCHES = new string[] { "Ald-ruhn" };
