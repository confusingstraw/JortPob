...
namespace JortPob.Common
{
    public static class Const
    {
        ...
        public static bool DEBUG_EXCLUSIVE_INTERIOR_BUILD_NAME(string name)
        {
            ...
            string[] MATCHES = new string[] { "Seyda Neen", "Addamasartus", "Nimawia Grotto", "Thelas Ancestral Tomb", "Samarys Ancestral Tomb", "Andrano Ancestral Tomb", "Abaesen-Pulu Egg Mine", "ToddTest" };
