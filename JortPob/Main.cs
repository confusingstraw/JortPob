...
namespace JortPob
{
    public class Main
    {
        ...
        {
            /* Working on regulatino decrypt and param editing. Too tired to contineu right now. will finish later. */

            BND4 guh = SoulsFormats.SFUtil.DecryptERRegulation(@"I:\SteamLibrary\steamapps\common\ELDEN RING\Game\mod\regulation.bin");
